...
const Services1 = () => {
  return (
    <>
      <div
        className="relative bg-cover bg-center flex items-center justify-center font-coolvetica "
        style={{
          backgroundImage: `url('src/assets/img/23.jpg')`,
          height: '50vh',
          marginTop: '10%',
        }}
      >
          <h1 className=" text-white  text-4xl font-bold text- bg-opacity-50 p-4 rounded-lg">
        Our Services
        </h1>
      </div>
         
      <section id="services" className="py-16  mt-[40px] mb-[56px] font-coolvetica ">
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-4 transition-opacity duration-500">
                  <h3 className="text-lg text-green-200">{service.title}</h3>
